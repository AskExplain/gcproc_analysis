...
write.csv(round(gene2pixel,2),"./data/workflow/gene2pixel.csv",quote=F,row.names=T,col.names=T)
write.csv(round(pixel2gene,2),"./data/workflow/pixel2gene.csv",quote=F,row.names=T,col.names=T)

write.csv(round(u,5),"./data/workflow/pixel_reduction.csv",quote=F,row.names=T,col.names=T)
write.csv(round(v,5),"./data/workflow/gene_reduction.csv",quote=F,row.names=T,col.names=T)

write.csv(round(as.matrix(x),2),"./data/workflow/main_image_as_gene_v1.csv",quote=F,row.names=T,col.names=T)

save.image(file = "./data/workflow/all.nanostring_via_atlas.gcproc.Rdata")
